                ...
                {filteredExpenses.map((expense) => (
                  <React.Fragment key={expense.id}>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <p className="text-slate-700 text-sm truncate max-w-[200px]">
                          {expense.title}
                        </p>
                      </td>
                      <td className="px-4 py-3">
                        ...
                        <td colSpan={7} className="px-4 py-4 bg-slate-50">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            ...
                            <div>
                              ...
                              <p className="text-slate-700">
                                {expense.reviewNote || 'No review note'}
                              </p>
                              {expense.paidOn && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md p-6 space-y-4">
            ...
            <div className="p-3 bg-slate-50 rounded-lg space-y-1">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-slate-800">
                  {reviewModal.expense.title}
                </span>
                <span className="text-sm font-bold text-slate-800">
                  {formatCurrency(reviewModal.expense.amount)}
                </span>
              </div>
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                onClick={() =>
                  handleReview(reviewModal.expense.id, reviewModal.action)
                }
                disabled={
                  actionLoading === reviewModal.expense.id ||
                  (reviewModal.action === 'rejected' && !reviewNote.trim())
                }
